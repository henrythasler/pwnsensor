...
Item {
    ...
    states:[
        ...
        State {
            name: "10"
            PropertyChanges { target: text_step9; visible:false}
            PropertyChanges { target: text_step10; visible:true}
...
//        color: "#ffffff"
        ...
        Text{ id: text_step4; x: 9; y: 37; width: 378; height: 152; wrapMode: Text.WordWrap; visible: false; color:"white";
            text: qsTr("Press and hold the Ctrl-key while using the <b>mouse wheel</b> to scale the chart vertically. The current scale is shown at the right edge of the chart.");
        }
        ...
        Text{ id: text_step10; x: 9; y: 37; width: 378; height: 152; wrapMode: Text.WordWrap; visible: false; color:"white";
